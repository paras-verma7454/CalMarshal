...
import HeroImage from "@/public/Event1.png"
    ...
    return (
        <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
            ...
            <div className="relative items-center w-full py-12 mx-auto mt-12">
                ...
                <Image src={HeroImage} alt="Hero Image"  className="relative object-cover w-full border rounded-lg shadow-2xl lg:rounded-2xl mt-5 "/>
            </div>
        </section>
    )
}